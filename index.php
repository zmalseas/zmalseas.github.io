      ...
      <nav class="primary" aria-label="Κύρια Πλοήγηση">
        <ul class="nav-links">
          ...
          <li class="nav-item dropdown">
            <a href="#"><span class="text">Η Εταιρία</span><span class="caret">▾</span></a>
            <div class="submenu" role="menu">
              <a href="etairia/company.html">Εταιρεία <span class="sm-arrow">→</span></a>
              <a href="etairia/team.html">Ομάδα <span class="sm-arrow">→</span></a>
              <a href="etairia/join-us.html">Γίνε Μέλος <span class="sm-arrow">→</span></a>
            </div>
          </li>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="submenu" role="menu">
              <a href="ipiresies/logistiki.php">Λογιστική Εταιρειών <span class="sm-arrow">→</span></a>
              ...
              <a href="ipiresies/social-media.php">Social Media Marketing <span class="sm-arrow">→</span></a>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="submenu" role="menu">
              <a href="efarmoges/rent-tax-calculator.html">Φόρος Ενοικίου <span class="sm-arrow">→</span></a>
...
<div class="overlay" aria-hidden="true">
  ...
  <div class="menu-wrap">
    <div class="menu-list">
      ...
      <div class="menu-item">
        <button class="menu-toggle">Η Εταιρία <span class="exp-caret">›</span></button>
        <div class="menu-sub">
          <a href="etairia/company.html">Εταιρεία</a>
          <a href="etairia/team.html">Ομάδα</a>
          <a href="etairia/join-us.html">Γίνε Μέλος</a>
        </div>
      </div>
      ...
      <div class="menu-item">
        ...
        <div class="menu-sub">
          <a href="ipiresies/logistiki.php">Λογιστική Εταιρειών</a>
          ...
          <a href="ipiresies/social-media.php">Social Media Marketing</a>
      ...
      <div class="menu-item">
        ...
        <div class="menu-sub">
          <a href="efarmoges/rent-tax-calculator.html">Φόρος Ενοικίου</a>
      ...
      <div class="overlay-footer-content">
        ...
        <div class="social-section">
          ...
          <div class="social-links">
            <a href="https://www.tiktok.com/@nerally_co?lang=el-GR" class="social-link tiktok" aria-label="TikTok" target="_blank" rel="noopener noreferrer">
              <svg viewBox="0 0 24 24" width="20" height="20">
                <path fill="currentColor" d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/>
              </svg>
            </a>
            <a href="https://www.instagram.com/nerally_co/" class="social-link instagram" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
              <svg viewBox="0 0 24 24" width="20" height="20">
            ...
            <a href="https://www.linkedin.com/company/nerally" class="social-link linkedin" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
              <svg viewBox="0 0 24 24" width="20" height="20">
