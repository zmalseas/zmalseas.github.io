    ...
    <section class="rent-wrap">
      <article class="rent-left">
        <section id="vat-info" class="vat-text">
            ...
            <p>Ο ΦΠΑ (Φόρος Προστιθέμενης Αξίας) είναι ένας φόρος πάνω στην “προστιθέμενη αξία” που δημιουργείται καθώς τα αγαθά και οι υπηρεσίες περνούν μέσα από την εφοδιαστική αλυσίδα μέχρι να φτάσουν στον τελικό καταναλωτή. Το τελικό βάρος του φόρου το επωμίζεται ο καταναλωτής. Τον ΦΠΑ τον εισπράττει μια επιχείρηση από τον αγοραστή και στη συνέχεια τον αποδίδει στο κράτος αφού αφαιρεθεί ο ΦΠΑ που η ίδια η επιχείρηση πλήρωσε στους προμηθευτές της. Έτσι, σε κάθε στάδιο της αλυσίδας, το κράτος εισπράττει μέρος του φόρου. Ο ΦΠΑ είναι έμμεση μορφή φορολογίας που χρησιμοποιείται παγκοσμίως.</p>
