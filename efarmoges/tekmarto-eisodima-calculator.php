...
<div class="rent-wrap">
  <div class="rent-left">
    ...
    <p>
      ...
      Ουσιαστικά, αποτελεί τη βάση φορολόγησης, που προκύπτει από αντικειμενικά κριτήρια όπως τα έτη λειτουργίας, το προσωπικό, ο τζίρος και οι αποδοχές υπαλλήλων.
    </p>

    <h3>Βασικές Παράμετροι 2025</h3>
    <ul>
      <li><strong>Βάση υπολογισμού:</strong> 14 × 830 € = 11.620 €</li>
      <li><strong>Προσαύξηση ετών:</strong> +1.162 € (7–9 έτη), +1.278 € (10–12 έτη), +1.406 € (>13 έτη)</li>
      <li><strong>Προσαύξηση μισθοδοσίας:</strong> +10 % του ετήσιου κόστους (μέχρι 15.000 €)</li>
      <li><strong>Υπέρβαση τζίρου:</strong> +5 % της διαφοράς από τον μέσο όρο του ΚΑΔ</li>
      <li><strong>Κριτήριο υψηλότερου μισθού:</strong> Αν κάποιος υπάλληλος έχει ετήσιες αποδοχές μεγαλύτερες από το ποσό που προκύπτει, το τεκμαρτό εξισώνεται με αυτές (μέχρι 30.000 €)</li>
      <li><strong>Ανώτατο όριο τεκμαρτού:</strong> 50.000 €</li>
    </ul>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 30px; margin-top: 20px;">
      ...
      <div>
        ...
        <ul style="margin-top: 0;">
          ...
          <li>Γονείς παιδιών με αναπηρία ≥ 67 %</li>
          <li>Εκμεταλλευτές ΤΑΞΙ με μερίδιο < 25 %</li>
          <li>Επαγγελματίες σε μικρούς οικισμούς (< 500 κατ.)</li>
          <li>Κοινότητες (< 1.500 κατ.)</li>
          <li>Νησιά (< 3.100 κατ.)</li>
        </ul>
      </div>
    </div>

    <h3 style="margin-top: 40px;">Κάλυψη Τεκμαρτού από Άλλα Εισοδήματα</h3>
    <p>
      Αν υπάρχουν εισοδήματα από μισθωτή εργασία, σύνταξη ή αγροτική δραστηριότητα, αυτά αφαιρούνται από το τεκμαρτό ποσό.<br>
      <strong>Παράδειγμα:</strong> Αν το τεκμαρτό σου είναι 14.000 € και έχεις 6.000 € από μισθωτή εργασία, τότε απομένουν 8.000 € για φορολόγηση.
    </p>
