    ...
    <div class="calculator-layout">
      ...
      <div class="left-section">
        <div class="calculator-container">
          <h1 class="page-title">Υπολογιστής Φόρου Ενοικίων</h1>
          <p class="page-description">
            Υπολογίστε εύκολα και γρήγορα τον φόρο που οφείλετε από ενοικιαστικά εισοδήματα. 
            Ο υπολογιστής μας λαμβάνει υπόψη τις τρεις φορολογικές κλίμακες και υπολογίζει 
            αυτόματα τις νόμιμες εκπτώσεις.
          </p>
          
          <div class="info-box">
            <h3>📋 Φορολογικές Κλίμακες 2025</h3>
            <ul>
              <li><strong>0€ - 12.000€:</strong> 15% φόρος</li>
              <li><strong>12.001€ - 35.000€:</strong> 35% φόρος</li>
              <li><strong>Πάνω από 35.000€:</strong> 45% φόρος</li>
            </ul>
          </div>
          ...
          <div class="tip-box">
            ...
            <p>
              Το φορολογητέο εισόδημα υπολογίζεται αφαιρώντας αυτόματα το 5% των εσόδων 
              ως τεκμαρτές δαπάνες συντήρησης και διαχείρισης.
            </p>
          </div>
        </div>
      </div>
