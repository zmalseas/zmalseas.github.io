        ...
        <div class="search-filters">
            ...
            <div class="filter-tags">
                <a href="<?php echo esc_url(home_url('/')); ?>" 
                   class="filter-tag <?php echo !is_tax() && !is_category() ? 'active' : ''; ?>">
                    Όλα
                </a>
                <?php
                ...
                if (!empty($categories)) {
                    foreach ($categories as $category) {
                        $active = (is_tax('article_category', $category->slug)) ? 'active' : '';
                        echo '<a href="' . esc_url(get_term_link($category)) . '" class="filter-tag ' . $active . '">';
                ...
                <?php while (have_posts()) : the_post(); ?>
                    ...
                    <article class="article-card">
                        ...
                        <div class="article-content">
                            ...
                            if ($reading_time) {
                                echo '<div class="article-reading-time">⏱️ ' . esc_html($reading_time) . ' λεπτά ανάγνωσης</div>';
                            }
                            ?>
