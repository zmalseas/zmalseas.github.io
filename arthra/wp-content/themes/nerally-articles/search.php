...
<section class="blog-container">
  <header class="blog-header">
    <h1 class="blog-title">Αναζήτηση</h1>
  ...
  <div class="posts-grid">
    <?php if (have_posts()): while (have_posts()): the_post(); ?>
      <article class="post-card">
        <a href="<?php the_permalink(); ?>">
          ...
          <?php else: ?>
            <img class="post-thumb" src="/images/Hero2_enhanced.webp" alt="" />
          <?php endif; ?>
          <div class="post-body">
    ...
    <?php endwhile; else: ?>
      <p>Δεν βρέθηκαν αποτελέσματα για «<?php echo esc_html( get_search_query() ); ?>».</p>
    <?php endif; ?>
  </div>
