...
<body class="contact-page">
  ...
  <section class="contact-hero">
    ...
    <div class="hero-content">
      <div class="container">
        <h1 class="hero-title">Ας συνεργαστούμε</h1>
        <p class="hero-subtitle">Είμαστε εδώ για να σας βοηθήσουμε με τις λογιστικές και φοροτεχνικές σας ανάγκες</p>
        <div class="hero-stats">
          ...
          <div class="stat-item">
            ...
            <span class="stat-label">Υποστήριξη</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="cta-section">
      <div class="container">
        <div class="cta-content">
          ...
          <p>Επικοινωνήστε μαζί μας σήμερα και ανακαλύψτε πώς μπορούμε να βοηθήσουμε την επιχείρησή σας να αναπτυχθεί.</p>
          <div class="cta-buttons">
            <a href="tel:+306946365798" class="cta-btn primary">📞 Κάλεσέ μας τώρα</a>
            <a href="mailto:info@nerally.gr" class="cta-btn secondary">✉️ Στείλε Email</a>
          </div>
        </div>
      </div>
    </section>
